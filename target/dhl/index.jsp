...
<%--      ${file}--%>
	  	<!-- here the info of the shipment -->
	  	 <div class="field">
	  		<label class="label is-large">Shipment Order/shipment details</label>
	  	</div>
        ...
        <div class="field">
	  		<label class="label is-large">Shipment Order/shiper</label>
	  	</div>
        ...
        <div class="field">
         ...
         <div class="field">
	  		<label class="label is-large">Shipment Order/receiver</label>
	  	</div>
        <div class="field">
            <label class="label">name</label>
            <div class="control">
